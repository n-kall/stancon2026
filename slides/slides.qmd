...
- Comparison between within-chain and between-chain variance
- R-hat > 1.01 indicates lack of convergence
- rank normalization, folding, splitting <div class="paper-link">
[see Vehtari et al. 2021](https://projecteuclid.org/journals/bayesian-analysis/volume-16/issue-2/Rank-Normalization-Folding-and-Localization--An-Improved-R%CB%86-for/10.1214/20-BA1221.full)
</div>
:::
## R-hat
```{r}
...
[see Margossian et al. 2025](https://projecteuclid.org/journals/bayesian-analysis/advance-publication/Nested-R%CB%86--Assessing-the-Convergence-of-Markov-Chain-Monte/10.1214/24-BA1453.full)
</div>
:::
## Nested R-hat
```{r}
...
- Measures how much *independent* information the draws contain, accounting for autocorrelation
...
- Quantifies whether the tails are too heavy to trust the mean/MCSE ([see Vehtari et al. 2024](https://jmlr.org/papers/v25/19-556.html))
...
- Compare the empirical CDF of these values to the diagonal line, or to a flat line at zero for the Δ-ECDF.
- <div class="paper-link">
[see Säilynoja et al. 2022](https://link.springer.com/article/10.1007/s11222-022-10090-6) and [Tesso et al. 2026](https://arxiv.org/abs/2603.02928)
</div>
:::
## 
```{r}
...
- <div class="paper-link">
[see Säilynoja et al. 2026](https://teemusailynoja.github.io/visual-predictive-checks/)
</div>
:::
...
- <div class="paper-link">
[see Suorsa and Vehtari 2026](https://arxiv.org/abs/2601.01662)
</div>
:::
...
- <div class="paper-link">
[see Kallioinen et al. 2024](https://link.springer.com/article/10.1007/s11222-023-10366-5)
</div>
:::
