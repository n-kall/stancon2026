...
# Load the observations and data fed to Stan
...
yrep_1 <-  as_draws_matrix(subset_draws(draws1, "y_rep"))
yrep_2 <-  as_draws_matrix(subset_draws(draws1, "y_rep"))
yrep_3 <-  as_draws_matrix(subset_draws(draws1, "y_rep"))
yrep_4 <-  as_draws_matrix(subset_draws(draws1, "y_rep"))
```
