...
def eight_schools_prior(ndraws=1000, mu_prior_sd=1, tau_prior_sd=1):
  ...
  with model:
    prior_predictive_draws = pm.sample_prior_predictive(samples=ndraws)
...
Check for prior and likelihood sensitivity in the eight schools model. First check by power-scaling all priors, then select only the "mu" and only the "tau" prior separately.
