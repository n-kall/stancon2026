...
patchwork::wrap_plots(c(p1, p2, p3), nrow = 3)
...
```{r}
#| fig-cap: "Rootogram showing the uncertainty in the predictions for a Poisson model."
ppc_rootogram(crabs_poisson$observed_data,
              crabs_poisson$posterior_predictive,
              style = "discrete")
```
:::
...
```{r}
#| fig-cap: "Rootogram showing the uncertainty in the predictions for a Hurdle Negative Binomial model."
ppc_rootogram(crabs_hurdle_nb$observed_data,
              crabs_hurdle_nb$posterior_predictive,
              style = "discrete")
```
:::
...
az.plot_ppc_pava(anes)
```
## R
```{r}
ppc_calibration(anes$observed_data,
                anes$posterior_predictive,
